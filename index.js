...
// let stadion = true;
// let info = `Родной город: ${city} Страна: ${country} Население: ${population} человек Есть ли стадион: ${stadion}`;
// console.log(info)
...
// }
// else{
//     console.log(`Число больше 20 и меньше 50`)
// }
